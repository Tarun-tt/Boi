...
function FormComponent({ mode }) {
  ...
  useEffect(() => {
    ...
    if (form.zone) {
      axios.post(`http://192.168.60.60:8080/o/commonApi/branchCode`, {
  ...
  return (
    <div className="container mt-4">
      <h3 style={{ color: '#00dcff' }}>Hindi QPR Branch March Part - 1 - 2025</h3>
    ...
    <div className="form-group mb-3">
      ...
      >
        ...
        {branchOptions.map((opt, i) => (
            ...
            <option key={i} value={opt.branchCode}>{opt.branchCode}</option>
    ...
    />
      ...
      />
        ...
        <div className="row mb-3">
          ...
          <label className="col-md-2">अंग्रेजी में प्राप्त पत्रों की संख्या</label>
          <label className="col-md-2">इनमें से कितनों के उत्तर हिंदी में दिए गए</label>
          <label className="col-md-2">इनमें से कितनों के उत्तर अंग्रेजी में दिए</label>

          <label className="col-md-2">इनमें से कितनों के उत्तर अपेक्षित नहीं थे</label>
        </div>
        <div className="row mb-3">
