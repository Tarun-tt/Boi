...
function FormComponent({ mode }) {
  ...
  return (
    <div className="container mt-4">
      <h3 style={{ color: "#00dcff" }}>
        Hindi QPR Branch March Part - 1 - 2025
      </h3>
      <label>
        <span style={{ color: "red" }}>*</span>Indicated required fields
      </label>
      <h4>
        <span>*</span>सरकारी क्षेत्र के बैंकों एवं वित्तीय संस्थाओं में राजभाषा
        हिंदी के प्रगामी प्रयोग से संबंधित तिमाही प्रगति रिपोर्ट
      </h4>
      <form onSubmit={handleSubmit}>
        ...
        <div className="row mb-3">
          <div className="col-md-4">
            <div className="form-group mb-3">
              <label>शाखा/कार्यालय का नाम--बैंक ऑफ इंडिया -1</label>
            </div>
          </div>
        ...
        <div className="row mb-3">
          ...
          <label className="mt-3">
            *इनमें सामान्य आदेश, ज्ञापन, संकल्प, अधिसूचनाएं, नियम, करार, संविदा,
            टेंडर नोटिस,संसदीय प्रश्न, आदि शामिल हैं।
          </label>
        </div>
        ...
        <div className="form-group mb-3">
          <label>
            3. अंग्रेजी में प्राप्त पत्रों के उत्तर हिंदी में दिए जाने की स्थिति
            (केवल ‘क’ और ‘ख’ क्षेत्रों में स्थित कार्यालयों के लिए)
          </label>
        </div>
        <div className="row mb-3">
        ...
        <div className="form-group mb-3">
          <label>
            5. (तिमाही के दौरान) फाइलों /दस्तावेजों पर हिंदी में लिखी गई
            टिप्पणियॉं
          </label>
        </div>
        ...
        <div className="row mb-3">
          <label className="col-md-6">
            पृष्‍ठों की संख्‍या की गणना पूर्ण अंक एवं आधा अंक में ही की जाए ।
          </label>
        ...
        <label>
          {" "}
          नोट : कार्यालय के समस्‍त कार्मिकों को 2 वर्ष में कम से कम एक बार
          प्रशिक्षित किया जाना आवश्‍यक है।
        </label>
        <div className="form-group mb-3 container">
          <label>
            7. विभागीय/संगठनीय राजभाषा कार्यान्‍वयन समिति की बैठक के आयोजन की
            तिथि
          </label>
          <div className="row mb-3">
            <label className="col-md-6">
              (क) राजभाषा कार्यान्वयन समिति की बैठक की तिथि (केंद्रीय/प्रधान
              कार्यालय की)
            </label>
            <label className="col-md-6">
          ...
          <div className="row mb-3">
            ...
            <label className="col-md-6">
              (घ) बैठकों से संबंधित कार्यसूची और कार्यवृत्त क्या हिंदी में जारी
              किये गये
            </label>
          </div>
          <div className="row mb-3">
            ...
            <div className="col-md-6">
              <div className="form-check form-check-inline">
                <input
                  ...
                  disabled={mode === "view"}
                />
                <label className="form-check-label" htmlFor="engLettersYes">
                  {" "}
                  हाँ
                </label>
              </div>
              <div className="form-check form-check-inline">
                <input
                  ...
                  disabled={mode === "view"}
                />
                <label className="form-check-label" htmlFor="engLettersNo">
                  नहीं
                </label>
              </div>
            </div>
        ...
        <div className="form-group mb-3 container">
          ...
          <div className="row mb-3">
            <label className="col-md-6">
              (i) पासबुक हिंदी में भरने (नाम,पता,जमा,डेबिट आदि) की सुविधा
              उपलब्‍ध है ?
            </label>
            <div className="col-md-6">
              <div className="form-check form-check-inline">
            ...
            <div className="col-md-6">
              <div className="form-check form-check-inline">
                <input
                  ...
                  id="engLettersYes"
                  value="yes"
                  checked={form.allFormsDualLanguage === "yes"}
                  onChange={handleChange}
                  disabled={mode === "view"}
                />
                <label className="form-check-label" htmlFor="engLettersYes">
          ...
          <div className="row mb-3">
            <label className="col-md-6">
              9. तिमाही में किए गए उल्लेखनीय कार्य/उपलब्धियों का संक्षिप्त विवरण
              (अधिकतम 250 कैरेक्टर)
            </label>
            <div className="col-md-6"> </div>
        ...
        <div className="form-group mb-3">
          <label>
            उल्लिखित सूचना उपलब्ध अभिलेखों के आधार पर बनाई गई है तथा मेरी
            जानकारी के अनुसार सही है |
          </label>
        </div>
        <div className="row mb-3">
        ...
        <label>
          नोट: कोई भी कॉलम खाली न छोड़ा जाए और सूचना स्पष्ट रूप से दी जाए।
        </label>
